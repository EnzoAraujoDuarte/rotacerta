...
export default function InvestmentBenefits() {
  ...
  const initialInvestment = 270000;
  ...
  const justifications = [
    {
      ...
      description: 'Investimento inicial de R$ 270 mil para desenvolvimento do app Flutter, APIs, infraestrutura AWS e aquisição de 55 smartphones. Gera ativo de longo prazo e propriedade intelectual.',
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 fade-in-up">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Investimento estratégico com CAPEX inicial de R$ 270 mil e OPEX mensal de R$ 119,3 mil, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border-l-4 border-blue-500">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                ...
                <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">R$ 270.000</p>
